...
function ENT:Setup(fwd, bck, stop, torque, direction, axis,scale)
	self.fwd = fwd
	self.bck = bck
...
duplicator.RegisterEntityClass("gmod_wire_wheel", WireLib.MakeWireEnt, "Data", "fwd", "bck", "stop", "BaseTorque", "direction", "Axis","scale")
